...
def draw_results(
    ...
    if len(detected) > 0:
        ...
        sex_prediction = np.argmax(predicted[0])
        age_class_prediction = np.argmax(predicted[1])
    ...
    for i, (x,y,w,h) in enumerate(detected):
        ...
        label = "{},{}".format(SEX_MAP[sex_prediction], AGE_CLASS_MAP[age_class_prediction])
...
def main():
    ...
    weight_file = os.path.abspath("../saves/UTKFace/CUSTOM_3/CUSTOM_3.h5")
    ...
    model = CustomModel(img_size, (img_size, img_size, 3) )()
